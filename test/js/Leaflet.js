...
!function(t, e, i) {
    ...
    o.Class.extend = function(t) {
        ...
        return t.statics && (o.extend(e, t.statics),
        delete t.statics),
    ...
    o.DomUtil = {
        ...
        setPosition: function(t, e) {
            t._leaflet_pos = e,
            o.Browser.any3d ? o.DomUtil.setTransform(t, e) : (t.style.left = e.x + "px",
            t.style.top = e.y + "px")
        },
    ...
    function() {
        ...
        o.DomUtil.preventOutline = function(e) {
            for (; e.tabIndex === -1; )
                e = e.parentNode;
            e && e.style && (o.DomUtil.restoreOutline(),
    ...
    o.LatLngBounds.prototype = {
        extend: function(t) {
            ...
            return n || s ? (n.lat = Math.min(e.lat, n.lat),
            n.lng = Math.min(e.lng, n.lng),
            s.lat = Math.max(i.lat, s.lat),
            s.lng = Math.max(i.lng, s.lng)) : (this._southWest = new o.LatLng(e.lat,e.lng),
    ...
    o.GridLayer = o.Layer.extend({
        ...
        _tileCoordsToBounds: function(t) {
            var e = this._map
              ...
              , r = e.unproject(n, t.z)
              , a = e.unproject(s, t.z);
            return this.options.noWrap || (r = e.wrapLatLng(r),
            a = e.wrapLatLng(a)),
    ...
    o.extend(o.DomEvent, {
        ...
        addDoubleTapListener: function(t, e, i) {
            function n(t) {
                var e;
                if (e = o.Browser.pointer ? o.DomEvent._pointersCount : t.touches.length,
                !(e > 1)) {
                    var i = Date.now()
                      , n = i - (r || i);
